...
const FAQSection = () => {
  ...
  return (
    // <div className="mx-auto px-4 lg:px-40 mt-10">
    ...
    //           <div
    //             className="p-4 bg-slate-400 cursor-pointer flex justify-between"
    ...
    <section className="bg-gray-900 text-orange-50 py-12 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-4">
          {faqData.map((faq, index) => (
            <div key={index} className="border border-orange-800 rounded-lg overflow-hidden">
              <button
              ...
              >
                <h3 className="text-left text-lg font-semibold text-orange-200">{faq.question}</h3>
                {activeIndex === index ? (
